...
require_once ABSPATH . 'wp-content/plugins/shopflix-bridge/shopflix-bridge.php';
...
function shopflix_fetch_order_callback() {
    ...
    // Assuming fetch_order_details is the function from the included file
    $order_details = fetch_shopflix_order($order_id);
